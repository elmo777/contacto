        ...
        <form action="{{url('check')}}"  method="post">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">
                <input type="email" name="email" id="typeEmailX" class="form-control form-control-lg"  placeholder="Correo" />
              </div>
            ...
            <div>
              <p class="mb-0">¿no tienes cuenta? <a href="{{url('register')}}" class="text-white-50 fw-bold">Crear cuenta</a>
              </p>
            </div>
        </form>
          </div>
